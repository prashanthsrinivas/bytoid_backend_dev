...
def get_or_create_thread(
    ...
    *,
    ...
    # NOTE: the "global"/"workspace" anchor is intentionally a SINGLE shared
    # thread across all participants — assessor and assessee collaborate in one
    # conversation regardless of which org they belong to or which page they open
    # it from. We deliberately do NOT namespace it by org (that split the
    # assessor's and assessee's views into separate threads). Access is still
    # gated by participant membership below.
