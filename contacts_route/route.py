...
@permission_required_body("contacts.create")
def save_contact():
...
@permission_required_body("contacts.edit")
...
@permission_required_body("contacts.delete")
def delete_contacts():
    connection = None
    try:
        data = request.get_json() or {}
...
@permission_required_body("contacts.view")
