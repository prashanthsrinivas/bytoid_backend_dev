...
# Statement ↔ tracker reverse-lookup graph (statement_tracker_refs)
STATEMENT_TRACKER_REF_UPSERT = "STATEMENT_TRACKER_REF_UPSERT"
STATEMENT_TRACKER_REF_DELETE = "STATEMENT_TRACKER_REF_DELETE"
STATEMENT_TRACKER_REF_RECONCILED = "STATEMENT_TRACKER_REF_RECONCILED"

# POLICY HUB share
POLICY_SHARED = "POLICY_SHARED"
POLICY_SHARE_REVOKED = "POLICY_SHARE_REVOKED"
POLICY_UPLOADED = "POLICY_UPLOADED"
TEMPLATE_REPLICATED = "TEMPLATE_REPLICATED"
...
RUNBOOK_RISK_UPDATED = "RUNBOOK_RISK_UPDATED"
...
GCP_DISCONNECTED = "GCP_DISCONNECTED"
...
# PROTECTED-MODULE GOVERNANCE (see security/protected_modules.yml)
PROTECTED_MODULE_CHANGE = "PROTECTED_MODULE_CHANGE"
PROTECTED_MODULE_SUPPRESSION_BLOCKED = "PROTECTED_MODULE_SUPPRESSION_BLOCKED"
PROTECTED_MODULE_AI_PROPOSAL_OPENED = "PROTECTED_MODULE_AI_PROPOSAL_OPENED"
PROTECTED_MODULE_AI_ONLY_APPROVAL_BLOCKED = "PROTECTED_MODULE_AI_ONLY_APPROVAL_BLOCKED"

# TESTS / SECURITY MODULE GOVERNANCE
TESTS_RUN_DISPATCHED = "TESTS_RUN_DISPATCHED"
TESTS_WEBHOOK_ACCEPTED = "TESTS_WEBHOOK_ACCEPTED"
TESTS_WEBHOOK_REJECTED = "TESTS_WEBHOOK_REJECTED"

# AI GOVERNANCE MODULE
AI_GUARDRAILS_CHECK = "AI_GUARDRAILS_CHECK"
AI_GUARDRAILS_CONFIG_READ = "AI_GUARDRAILS_CONFIG_READ"
AI_GUARDRAILS_RELOAD = "AI_GUARDRAILS_RELOAD"
AI_OBSERVABILITY_TRACES_READ = "AI_OBSERVABILITY_TRACES_READ"
AI_OBSERVABILITY_SCORE_POSTED = "AI_OBSERVABILITY_SCORE_POSTED"
AI_MLFLOW_RUNS_READ = "AI_MLFLOW_RUNS_READ"
AI_MLFLOW_RUN_LOGGED = "AI_MLFLOW_RUN_LOGGED"
AI_MLFLOW_EXPLAIN_RAN = "AI_MLFLOW_EXPLAIN_RAN"
AI_FAIRNESS_AIF360_ANALYZED = "AI_FAIRNESS_AIF360_ANALYZED"
AI_FAIRNESS_FAIRLEARN_MITIGATED = "AI_FAIRNESS_FAIRLEARN_MITIGATED"
AI_FAIRNESS_AEQUITAS_AUDITED = "AI_FAIRNESS_AEQUITAS_AUDITED"
AI_GISKARD_SCAN_STARTED = "AI_GISKARD_SCAN_STARTED"
AI_GISKARD_RESULTS_READ = "AI_GISKARD_RESULTS_READ"
AI_TRULENS_FEEDBACK_POSTED = "AI_TRULENS_FEEDBACK_POSTED"
AI_TRULENS_LEADERBOARD_READ = "AI_TRULENS_LEADERBOARD_READ"
AI_DEEPEVAL_RUN = "AI_DEEPEVAL_RUN"
AI_GOVERNANCE_ACCESS_DENIED = "AI_GOVERNANCE_ACCESS_DENIED"
AI_GUARDRAIL_RULE_CREATED = "AI_GUARDRAIL_RULE_CREATED"
AI_GUARDRAIL_RULE_UPDATED = "AI_GUARDRAIL_RULE_UPDATED"
AI_GUARDRAIL_RULE_DELETED = "AI_GUARDRAIL_RULE_DELETED"
AI_GUARDRAIL_VIOLATION = "AI_GUARDRAIL_VIOLATION"
# AI GOVERNANCE SCAN (platform-wide Giskard sweep)
AI_GOVSCAN_BATCH_STARTED = "AI_GOVSCAN_BATCH_STARTED"
AI_GOVSCAN_BATCH_COMPLETED = "AI_GOVSCAN_BATCH_COMPLETED"
AI_GOVSCAN_USER_COMPLETED = "AI_GOVSCAN_USER_COMPLETED"
AI_GOVSCAN_USER_FAILED = "AI_GOVSCAN_USER_FAILED"
AI_GOVSCAN_RESULTS_READ = "AI_GOVSCAN_RESULTS_READ"
...
ACTION_CATEGORY = {
    ...
    "STATEMENT_TRACKER_REF_UPSERT": "tracker",
    "STATEMENT_TRACKER_REF_DELETE": "tracker",
    "STATEMENT_TRACKER_REF_RECONCILED": "tracker",
    # POLICY HUB
    "POLICY_SHARED": "policy_hub",
    "POLICY_SHARE_REVOKED": "policy_hub",
    "POLICY_UPLOADED": "policy_hub",
    "TEMPLATE_REPLICATED": "policy_hub",
    "TEMPLATE_EDITED": "policy_hub",
    "TEMPLATE_RESET": "policy_hub",
    "TEMPLATE_APPLIED": "policy_hub",
    # TRUST CENTER
    ...
    "GCP_CONNECTED": "account",
    "GCP_DISCONNECTED": "account",
    # SECURITY
    ...
    "SPECIAL_ACCESS_MODIFIED": "admin_access",
    # PROTECTED-MODULE GOVERNANCE
    "PROTECTED_MODULE_CHANGE": "governance",
    "PROTECTED_MODULE_SUPPRESSION_BLOCKED": "governance",
    "PROTECTED_MODULE_AI_PROPOSAL_OPENED": "governance",
    "PROTECTED_MODULE_AI_ONLY_APPROVAL_BLOCKED": "governance",
    # TESTS / SECURITY MODULE
    "TESTS_RUN_DISPATCHED": "tests",
    "TESTS_WEBHOOK_ACCEPTED": "tests",
    "TESTS_WEBHOOK_REJECTED": "tests",
    # AI GOVERNANCE MODULE
    "AI_GUARDRAILS_CHECK": "ai_governance",
    "AI_GUARDRAILS_CONFIG_READ": "ai_governance",
    "AI_GUARDRAILS_RELOAD": "ai_governance",
    "AI_OBSERVABILITY_TRACES_READ": "ai_governance",
    "AI_OBSERVABILITY_SCORE_POSTED": "ai_governance",
    "AI_MLFLOW_RUNS_READ": "ai_governance",
    "AI_MLFLOW_RUN_LOGGED": "ai_governance",
    "AI_MLFLOW_EXPLAIN_RAN": "ai_governance",
    "AI_FAIRNESS_AIF360_ANALYZED": "ai_governance",
    "AI_FAIRNESS_FAIRLEARN_MITIGATED": "ai_governance",
    "AI_FAIRNESS_AEQUITAS_AUDITED": "ai_governance",
    "AI_GISKARD_SCAN_STARTED": "ai_governance",
    "AI_GISKARD_RESULTS_READ": "ai_governance",
    "AI_TRULENS_FEEDBACK_POSTED": "ai_governance",
    "AI_TRULENS_LEADERBOARD_READ": "ai_governance",
    "AI_DEEPEVAL_RUN": "ai_governance",
    "AI_GOVERNANCE_ACCESS_DENIED": "ai_governance",
    "AI_GUARDRAIL_RULE_CREATED": "ai_governance",
    "AI_GUARDRAIL_RULE_UPDATED": "ai_governance",
    "AI_GUARDRAIL_RULE_DELETED": "ai_governance",
    "AI_GUARDRAIL_VIOLATION": "ai_governance",
    "AI_GOVSCAN_BATCH_STARTED": "ai_governance",
    "AI_GOVSCAN_BATCH_COMPLETED": "ai_governance",
    "AI_GOVSCAN_USER_COMPLETED": "ai_governance",
    "AI_GOVSCAN_USER_FAILED": "ai_governance",
    "AI_GOVSCAN_RESULTS_READ": "ai_governance",
}
