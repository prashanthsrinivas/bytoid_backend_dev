...
def get_all_instructions():
    ...
    # Users without a subagent have nothing to return
    if not subagent_id:
        return jsonify({"data": [], "is_admin": False})
...
def pb_temp_clone_min():
    try:
        ...
        # ---------------------------------
        # ✅ Load workflow from caller's space, falling back to global if requested.
        # ---------------------------------
